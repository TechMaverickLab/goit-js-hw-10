...
/* global document */ document.addEventListener("DOMContentLoaded", async ()=>{
    ...
    try {
        ...
        const breeds = await (0, _catApiJs.fetchBreeds)();
    ...
    breedSelect.addEventListener("change", async ()=>{
        ...
        try {
            loader.classList.remove("hidden");
            catInfo.classList.add("hidden");
            const catData = await (0, _catApiJs.fetchCatByBreed)(selectedBreedId);
    ...
    document.addEventListener("click", (event)=>{
        if (event.target.classList.contains("cat-image") && event.target.src) {
            if (modal.style.display !== "flex") {
                ...
                } else captionText.style.display = "none";
            }
        } else if (event.target === modal || event.target === closeModal) modal.style.display = "none";
    });
});

},{"./cat-api.js":"69Tjm"}],"69Tjm":[function(require,module,exports) {
...
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_IlxTCE8YSC24414EQo40TXBc0MGBSsE5sxGaBHATmcJqGsIpvmZ3GrgtJpBnSveg";
...
},{"adfd9b103875c2dd":"4q20x","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4q20x":[function(require,module,exports) {
/*!
...
var base64 = require("96f156f3914c0f84");
var ieee754 = require("3b69743a32808809");
...
},{"96f156f3914c0f84":"4rwUz","3b69743a32808809":"8pLif"}],"4rwUz":[function(require,module,exports) {
"use strict";
...
},{}],"8pLif":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iSP81","1Z4Rq"], "1Z4Rq", "parcelRequire7bc7")
